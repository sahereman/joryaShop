            ...
            <div class="article-nvarchar main-content">
                ...
                <div class="nvarchar-modules">
                    ...
                    <div class="our-services">
                        <p class="services-title"><span>Our Service</span></p>
                    ...
                    {{-- 证书轮播 --}}
                    <div class="certificate-by">
                        <div class="swiper-container" id="certificateBy">
                            <div class="swiper-wrapper">
                                @if($poster = \App\Models\Poster::getPosterBySlug('about_us'))
                                    @foreach($poster->photo_urls as $photo_url)
                                        <div class="swiper-slide">
                                            <div class="slide-img">
                                                <img src="{{ $photo_url }}" alt="lyricalhair.com">
                                            </div>
                                        </div>
                                    @endforeach
                                @else
                                    <div class="swiper-slide">
                                        <div class="slide-img">
                                            <img src="{{ asset('img/Home/photo-wall-4.png') }}" alt="lyricalhair.com">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slide-img">
...
@section('scriptsAfterJs')
    ...
    <script type="text/javascript">
        var productZoneswiper = new Swiper('#certificateBy', {
            autoplay: true,
            slidesPerView: 4,
            spaceBetween: 30,
            loop: true,
