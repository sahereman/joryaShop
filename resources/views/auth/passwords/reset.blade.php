                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <div class="">
                        	<label class="reset_email">
                        		<span>邮箱</span>
                        		<input id="email" type="email"  name="email" value="{{ old('email') }}" readonly required placeholder="请输入邮箱">
                        	</label>
                            <label class="reset_code">
                            	<span>验证码</span>
                            	<input id="code" type="text" name="code" value="{{ old('code') }}" placeholder="请输入验证码" required>
