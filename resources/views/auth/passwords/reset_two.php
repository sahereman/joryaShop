                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <div class="">
                        	<label class="reset_psw_new">
                        		<span>新密码</span>
                        		<input id="new_psw" type="password"  name="password" value="{{ old('password') }}" required placeholder="请输入新密码">
                        	</label>
                            ...
                            <label class="reset_psw_sure">
                            	<span>确认密码</span>
                            	<input id="makeSure" type="password" name="makeSure" value="{{ old('makeSure') }}" placeholder="请输入再次输入密码" required>
                            </label>
                            @if ($errors->has('makeSure'))
                                <span class="help-block">
                                	<img src="{{ asset('img/error_fork.png') }}">
                                    <strong>{{ $errors->first('makeSure') }}</strong>
                                </span>
                            @endif
                        </div>
                    </div>
