...
@section('title', (App::isLocale('zh-CN') ? '地址列表' : 'Address List') . ' - ' . \App\Models\Config::config('title'))
@section('content')
    <div class="headerBar">
    ...
    <div class="ads1Box">
        ...
        @endif
        <div class="btnBox">
            <a href="{{ route('mobile.user_addresses.create') }}" class="doneBtn">
                @lang('basic.address.The new address')
            </a>
        </div>
    </div>
@endsection
