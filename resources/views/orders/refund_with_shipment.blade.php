            		...
            		<div class="pull-left left_content">
            				...
            				<form method="POST" action="{{ route('orders.store_refund_with_shipment',32) }}" enctype="multipart/form-data" id="step-1-form">
			                    ...
			                    <ul class="step-1-ul step-ul">
			                    	...
			                    	<li>
			                    		...
			                    		<input type="file" name="image" value="" id="refunds_photos_file" onchange="imgChange(this)">
	            			...
	            			<form method="POST" action="{{ route('orders.update_refund_with_shipment',32) }}" enctype="multipart/form-data" id="step-2-form">
			                    ...
			                    <ul class="step-1-ul step-ul">
			                    	...
			                    	<li>
			                    		...
			                    		<input type="file" name="image" value="" id="refunds_photos_2" onchange="imgChange(this)">
			                    		<input type="hidden" name="photos">
			                    		<!--获取的图片按照下面的格式存放不超过3张-->
			                    		@for ($i = 0; $i < 3; $i++)
				                    		<div class='refund-path' data-path='图片的path如果有的话在这个位置'>
				                    		    <img src="{{ asset('img/refund-1.png') }}" data-path='图片的path如果有的话在这个位置'>
				                    		    <img class='del_btn dis_n' src="{{ asset('img/delete_refund_photos.png') }}"/>
			                    		    </div>
		                    		    @endfor
			                    	</li>
			                    </ul>
	            		...
	            		<div class="step_content step-3" style="display: none;">
	            			<div class="read_info">
	            				...
	            				<p class="read_info_title" style="display: none;">卖家验货成功</p>
	            				<div class="read_address_info">
	            					<p>退货地址</p>
	            					<p><span>联系人：</span><span>小王</span></p>
	            					<p><span>联系方式：</span><span>18655668877</span></p>
	            					<p><span>联系地址：</span><span>山东省青岛市市北区敦化路328号诺德广场</span></p>
	            				</div>
	            				<ul class="step-ul">
	            					<li>
			                    		<span>退款金额：</span>
			                    	...
			                    	<li>
			                    		...
			                    		@for ($i = 0; $i < 3; $i++)
				                    		<div class='refund-path'>
				                    		    <img src="{{ asset('img/refund-1.png') }}">
			                    		    </div>
		                    		    @endfor
			                    	</li>
	            				</ul>
	            			</div>
	            			<form method="POST" action="{{ route('orders.store_refund_with_shipment',32) }}" enctype="multipart/form-data" id="step-3-form">
		            			{{ csrf_field() }}
			                    <input type="hidden" name="order_id" value="">
			                    <ul class="step-1-ul step-ul">
			                    	<li>
			                    		<span><i class="red">*</i>物流公司：</span>
			                    		<input type="text" class="refund_company" value="">
			                    	</li>
			                    	<li>
			                    		<span><i class="red">*</i>物流单号：</span>
			                    		<input type="text" class="refund_ numbers" value="">
			                    	</li>
			                    	<li>
			                    		<span><i class="red">*</i>备注内容：</span>
			                    		<textarea class="remarks_for_refunds" placeholder="请填写备注内容"></textarea>
			                    	</li>
			                    	<li>
			                    		...
			                    		<input type="file" name="image" value="" id="refunds_photos_bill" onchange="imgChange(this)">
			                    		<input type="hidden" name="photos">
			                    	</li>
			                    </ul>
		            		</form>	
	            		...
	            		<!--第四步退款成功-->
	            		<div class="step_content step-4" style="display: none;">
	            			<div class="read_info">
