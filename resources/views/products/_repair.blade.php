...
<div id="sku-choose-store" class="sku-choose-store {{ $product->type == \App\Models\Product::PRODUCT_TYPE_CUSTOM ? ' dis_ni' : '' }}" price="{{ $product->price }}">
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Refilled hair color" value="I'll send in the hair sample(s)"
                       name="I'll send in the hair sample(s)" photo-url="" delta-price="0.00">
                <span class="sku-select-value-show">I'll send in the hair sample(s)</span>
            </div>
            <div class="sku-select-options" style="display: none;">
                <ul data-paramid="undefined" data-name="undefined">
                    <li data-paramid="Refilled hair color" data-valueid="I'll send in the hair sample(s)" photo-url="" delta-price="0.00">
                        <span class="text-span">I'll send in the hair sample(s)</span>
                    </li>
                    <li data-paramid="Refilled hair color" data-valueid="Make colors same as my old system" photo-url="" delta-price="0.00">
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Replace new front" value="I want to make a change"
                       name="I want to make a change" photo-url="" delta-price="0.00">
                <span class="sku-select-value-show">I want to makea change</span>
            </div>
            <div class="sku-select-options" style="display: none;">
                <ul data-paramid="undefined" data-name="undefined">
                    ...
                    <li data-paramid="Replace new front" data-valueid="Replace a new front,same material as the old unit"
                    ...
                    <li data-paramid="Replace new front" data-valueid="I want to make a change" photo-url=""
                        delta-price="{{ get_current_price(19.00) }}" delta-property="{{ get_current_price(19.00) }}">
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Repair minor tears" value="No need to repair tears"
                       name="No need to repair tears" photo-url="" delta-price="75.00">
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Rush service" value="Average service"
                       name="Average service" photo-url="" delta-price="210.00">
