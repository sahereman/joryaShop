...
<div id="sku-choose-store" class="sku-choose-store {{ $product->type == \App\Models\Product::PRODUCT_TYPE_CUSTOM ? ' dis_ni' : '' }}" price="{{ $product->price }}">
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Hair Cut" value="No,I will have my hair cut-in and styled by my stylist"
                       name="No,I will have my hair cut-in and styled by my stylist" photo-url="" delta-price="0.00">
            ...
            <div class="sku-select-options" style="display: none;">
                <ul data-paramid="undefined" data-name="undefined">
                    <li data-paramid="Hair Cut" data-valueid="No,I will have my hair cut-in and styled by my stylist" photo-url="" delta-price="0.00">
                        <span class="text-span">No,I will have my hair cut-in and styled by my stylist</span>
                    </li>
                    <li data-paramid="Hair Cut" data-valueid="Yes, have hair cut-in and styled (need extra 3 working days)"
                        photo-url="" delta-price="{{ get_current_price(20.00) }}" delta-property="{{ get_current_price(20.00) }}">
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Base size" value='Partial (size < 4"x4", or area < 16 square inches)'
                       name='Partial (size < 4"x4", or area < 16 square inches)' photo-url="" delta-price="0.00">
                <span class="sku-select-value-show">Partial (size < 4"x4", or area < 16 square inches)</span>
            </div>
            <div class="sku-select-options" style="display: none;">
                <ul data-paramid="undefined" data-name="undefined">
                    <li data-paramid="Base size" data-valueid='Regular (4"x4"≤ size ≤8"x10", or 16 square inches≤ area ≤80 square inches)'
                        photo-url="" delta-price="0.00">
                        <span class="text-span">Regular (4"x4"≤ size ≤8"x10", or 16 square inches≤ area ≤80 square inches)</span>
                    </li>
                    <li data-paramid="Base size" data-valueid='Partial (size < 4"x4", or area < 16 square inches)'
                    ...
                    <li data-paramid="Base size" data-valueid='Oversize (8"x10"< size <10"x10", or 80 square inches< area <100 square inches)'
                    ...
                    <li data-paramid="Base size" data-valueid='Full cap (size ≥ 10"x10", or area ≥ 100 square inches)'
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Hair color" value="Match the sample I′ll send in(Recommended)"
                       name="Match the sample I′ll send in(Recommended)" photo-url="" delta-price="0.00">
            ...
            <div class="sku-select-options" style="display: none;">
                <ul data-paramid="undefined" data-name="undefined">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 8''" photo-url=""
                        delta-price="{{ get_current_price(29.00) }}" delta-property="{{ get_current_price(29.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 10''" photo-url=""
                        delta-price="{{ get_current_price(35.00) }}" delta-property="{{ get_current_price(35.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 12''" photo-url=""
                        delta-price="{{ get_current_price(45.00) }}" delta-property="{{ get_current_price(45.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 14''" photo-url=""
                        delta-price="{{ get_current_price(60.00) }}" delta-property="{{ get_current_price(60.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 16''" photo-url=""
                        delta-price="{{ get_current_price(80.00) }}" delta-property="{{ get_current_price(80.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 18''" photo-url=""
                        delta-price="{{ get_current_price(110.00) }}" delta-property="{{ get_current_price(110.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 20''" photo-url=""
                        delta-price="{{ get_current_price(150.00) }}" delta-property="{{ get_current_price(150.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 22''" photo-url=""
                        delta-price="{{ get_current_price(200.00) }}" delta-property="{{ get_current_price(200.00) }}">
                    ...
                    <li data-paramid="Hair length" data-valueid="Longest at 24''" photo-url=""
                        delta-price="{{ get_current_price(250.00) }}" delta-property="{{ get_current_price(250.00) }}">
        ...
        <div class="sku-select-module">
            ...
            <div class="sku-select-options" style="display: none;">
                <ul data-paramid="undefined" data-name="undefined">
                    ...
                    <li data-paramid="Hair type" data-valueid="Remy hair (best)" photo-url="" delta-price="{{ get_current_price(59.00) }}"
                    ...
                    <li data-paramid="Hair type" data-valueid='European hair (fine, thin & soft, 7" and up is not available)' photo-url=""
                        delta-price="{{ get_current_price(49.00) }}" delta-property="{{ get_current_price(49.00) }}">
                    ...
                    <li data-paramid="Hair type" data-valueid="Chinese hair (coarse, good for extremely straight)" photo-url="" delta-price="0.00">
                        <span class="text-span">Chinese hair (coarse, good for extremely straight)</span>
                    </li>
    ...
    <div class="sku-select">
        ...
        <div class="sku-select-module">
            <div data-paramid="undefined" data-name="undefined" class="sku-select-value">
                <input type="hidden" readonly="" data-paramid="Your system age" value="Between 6 to 12 Months"
                       name="Between 6 to 12 Months" photo-url="" delta-price="0.00">
