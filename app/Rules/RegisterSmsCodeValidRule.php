...
class RegisterSmsCodeValidRule implements Rule
{
    ...
    {
        if (Cache::has('register_sms_code-' . $this->country_code . '-' . $this->phone_number)) {
            $this->is_expired = false;
            return Cache::get('register_sms_code-' . $this->country_code . '-' . $this->phone_number) == $value;
        }
        return false;
    }
