...
Route::post('orders/integrate', 'OrdersController@integrate')->name('mobile.orders.integrate'); // 多个订单聚合支付

/*支付*/
Route::get('payments/{payment}/method', 'PaymentsController@method')->name('mobile.payments.method'); // 选择支付方式页面
